...
function SheetInput({
  label, value, onChange, placeholder, keyboardType, optional,
}: {
...
export default function AddRiderSheet() {
  ...
  const handleSave = () => {
    ...
    addRider({ name: name.trim(), phone: phone.trim() });
    showToast("Rider saved ✓", "success");
    router.back();
  };
