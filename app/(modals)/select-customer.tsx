  ...
  return (
    ...
    >
      ...
      <View style={styles.searchWrap}>
        <View
          style={[styles.searchBar, { backgroundColor: colors.surfaceCard }]}
        >
      ...
      >
          ...
          return (
            ...
            >
              ...
              <View style={[styles.avatar, { backgroundColor: ac.bg }]}>
                <Text style={[styles.avatarText, { color: ac.fg }]}>
                  {initials(c.name)}
                </Text>
              </View>
        ...
        >
          <View
            style={[styles.addAvatar, { backgroundColor: colors.primarySoft }]}
          >
